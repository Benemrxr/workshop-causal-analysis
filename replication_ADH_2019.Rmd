...
###Summary Mainshock
```{r}
stargazer(mainshock_mf, mainshock_m, mainshock_f, title = "Table 1, Panel A", dep.var.labels = c("M+F","M","F"), keep = c("d_impusch_p9"), style = "default", type = "text", dep.var.caption = "Manufacturing employment as a share of population, age 18–39", covariate.labels = "Delta Import Penetration")
```
